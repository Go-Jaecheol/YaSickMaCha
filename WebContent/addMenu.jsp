...
<body>
	<%
		...
		System.out.println(mid);
		String mname = request.getParameter("add_mname");
		System.out.println(mname);
		String quantity = request.getParameter("add_quantity");
		System.out.println(quantity);
		String isMenuForMembership = request.getParameter("add_isMenuForMembership");
		System.out.println(isMenuForMembership);
		String storeN = request.getParameter("add_storeN");
		...
		String seasonId = request.getParameter("add_seasonId");
